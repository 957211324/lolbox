...
public class JiongAdapter extends RecyclerView.Adapter<JiongAdapter.ViewHolder>
{

    private Context mContext;
    private List<JiongPhoto> mList;
    private int mWidth = 0;

    public JiongAdapter(Context mContext)
    {
    ...
    public void update(List<JiongPhoto> list, int type)
    {
    ...
    {
        View layout = LayoutInflater.from(mContext).inflate(R.layout.item_msg_jiong, parent, false);
