...
public class DiscoverCombatActivity extends BaseActivity
{
    ...
    {
        return R.layout.activity_discover_combat;
    }
    ...
    {
        super.initView();
        mLayoutTitle.setText("比赛详情");
        if (mUrl == null || mUrl.equals(""))
        {
            mUrl = getIntent().getStringExtra("DiscoverCombatActivity");
        }
