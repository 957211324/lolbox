...
public class CharmingAdapter extends RecyclerView.Adapter<CharmingAdapter.ViewHolder>
{

    private Context mContext;
    private List<CharmingPhoto> mList;
    private int mWidth = 0;

    public CharmingAdapter(Context mContext)
    {
     ...
     * @param list
     */
    public void update(List<CharmingPhoto> list, int type)
    {
    ...
    {
        View layout = LayoutInflater.from(mContext).inflate(R.layout.item_msg_charming, parent, false);
