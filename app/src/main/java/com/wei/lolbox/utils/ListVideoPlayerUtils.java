...
public class ListVideoPlayerUtils
{
    /**
     * 该类从该版本开始不再维护，望悉知
     */
    private String TAG = "NULL"; //播放的标志
    private VideoPlayer gsyVideoPlayer;
    ...
    public ListVideoPlayerUtils(Context context)
    {
        gsyVideoPlayer = new VideoPlayer(context);
    ...
    public void startPlay(final String url)
    {
        ...
        gsyVideoPlayer.getBottomStart().setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                ...
                gsyVideoPlayer.setBottomStartType();
            }
        });
