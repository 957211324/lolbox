...
/** 
 * DAO for table "JIONG_PHOTO".
*/
public class JiongPhotoDao extends AbstractDao<JiongPhoto, String> {

    public static final String TABLENAME = "JIONG_PHOTO";

    /**
     * Properties of entity JiongPhoto.<br/>
    ...
    public JiongPhotoDao(DaoConfig config) {
        super(config);
    }
    
    public JiongPhotoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"JIONG_PHOTO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"JIONG_PHOTO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, JiongPhoto entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, JiongPhoto entity) {
        stmt.clearBindings();
    ...
    @Override
    public JiongPhoto readEntity(Cursor cursor, int offset) {
        JiongPhoto entity = new JiongPhoto( //
    ...
    @Override
    public void readEntity(Cursor cursor, JiongPhoto entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(JiongPhoto entity, long rowId) {
        return entity.getGalleryId();
    }
    
    @Override
    public String getKey(JiongPhoto entity) {
        if(entity != null) {
            return entity.getGalleryId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(JiongPhoto entity) {
