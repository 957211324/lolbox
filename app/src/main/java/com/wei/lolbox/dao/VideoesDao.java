...
/** 
 * DAO for table "VIDEOES".
*/
public class VideoesDao extends AbstractDao<Videoes, String> {

    public static final String TABLENAME = "VIDEOES";

    /**
     * Properties of entity Videoes.<br/>
    ...
    public VideoesDao(DaoConfig config) {
        super(config);
    }
    
    public VideoesDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"VIDEOES\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"VIDEOES\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Videoes entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Videoes entity) {
        stmt.clearBindings();
    ...
    @Override
    public Videoes readEntity(Cursor cursor, int offset) {
        Videoes entity = new Videoes( //
    ...
    @Override
    public void readEntity(Cursor cursor, Videoes entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(Videoes entity, long rowId) {
        return entity.getId();
    }
    
    @Override
    public String getKey(Videoes entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Videoes entity) {
