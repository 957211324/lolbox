...
/** 
 * DAO for table "CHARMING_PHOTO".
*/
public class CharmingPhotoDao extends AbstractDao<CharmingPhoto, String> {

    public static final String TABLENAME = "CHARMING_PHOTO";

    /**
     * Properties of entity CharmingPhoto.<br/>
    ...
    public CharmingPhotoDao(DaoConfig config) {
        super(config);
    }
    
    public CharmingPhotoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CHARMING_PHOTO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CHARMING_PHOTO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CharmingPhoto entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CharmingPhoto entity) {
        stmt.clearBindings();
    ...
    @Override
    public CharmingPhoto readEntity(Cursor cursor, int offset) {
        CharmingPhoto entity = new CharmingPhoto( //
    ...
    @Override
    public void readEntity(Cursor cursor, CharmingPhoto entity, int offset) {
    ...
    @Override
    protected final String updateKeyAfterInsert(CharmingPhoto entity, long rowId) {
        return entity.getGalleryId();
    }
    
    @Override
    public String getKey(CharmingPhoto entity) {
        if(entity != null) {
            return entity.getGalleryId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(CharmingPhoto entity) {
